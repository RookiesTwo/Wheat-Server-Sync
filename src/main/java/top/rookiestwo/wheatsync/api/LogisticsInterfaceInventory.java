package top.rookiestwo.wheatsync.api;
...
public interface LogisticsInterfaceInventory extends Inventory {
     ...
     * 从物品列表创建物品栏。
     */
    static LogisticsInterfaceInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     * 根据指定的尺寸创建新的物品栏。
     */
    static LogisticsInterfaceInventory ofSize(int size) {
